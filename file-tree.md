...
- `XuanYu.World.Tests/UiRuntime/XYUIVisualAuthorityContractTests.cs` - C# source/runtime contract tests for XYUI visual authority and legacy native button scoping.
