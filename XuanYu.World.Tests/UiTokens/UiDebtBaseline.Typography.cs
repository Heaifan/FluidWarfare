...
internal static partial class UiDebtBaseline
{
    private static void AddTypography(System.Collections.Generic.List<BaselineEntry> list)
    {
        ...
        list.Add(new("W71-GEN", "XuanYu.Editor.UI/Top/Top.axaml", "Style:Button.topCommand", UiRuleKind.ControlHeight, "MinHeight", "32"));
        list.Add(new("W22", "XuanYu.Editor.UI/Top/Top.axaml", "Style:Button.topCommand", UiRuleKind.CornerRadius, "CornerRadius", "4"));
        list.Add(new("W71-GEN", "XuanYu.Editor.UI/Top/Top.axaml", "Style:ToggleButton.topTool", UiRuleKind.ControlHeight, "MinHeight", "32"));
        list.Add(new("W22", "XuanYu.Editor.UI/Top/Top.axaml", "Style:ToggleButton.topTool", UiRuleKind.CornerRadius, "CornerRadius", "4"));
