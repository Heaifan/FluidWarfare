...
public static partial class XyuiComponentStyles
{
    static void BottomNavigation(Styles styles)
    {
        ...
        var badgeCount = new Style(x => x.OfType<XYStatusBadge>().Class("xyui-bottom-navigation-badge")); badgeCount.Setters.Add(new Setter(Border.MarginProperty, new Thickness(0, -3, -8, 0))); badgeCount.Setters.Add(new Setter(TemplatedControl.FontSizeProperty, 9d)); styles.Add(badgeCount);
        var primaryHost = new Style(x => x.OfType<Grid>().Class("xyui-bottom-navigation-primary-host")); primaryHost.Setters.Add(new Setter(Visual.ClipToBoundsProperty, false)); primaryHost.Setters.Add(new Setter(Layoutable.MarginProperty, new Thickness(0, -14, 0, 0))); styles.Add(primaryHost);
