...
public sealed partial class XYMenu
{
    ...
    protected override void OnKeyDown(KeyEventArgs e)
    {
        ...
        if (e.Key == Key.Right && FocusedItem() is { } parent) { parent.OpenSubMenu(); e.Handled = true; return; }
        if (e.Key == Key.Left) { Close(); e.Handled = true; return; }
        base.OnKeyDown(e);
    }
    ...
    public XYMenuItem? CurrentItem => FocusedItem();
}
