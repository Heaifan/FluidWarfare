...
public sealed partial class XYBackForwardNavigation : Border
{
    ...
    Control Build()
    {
        var inner = new Grid { Height = 34, ColumnDefinitions = new ColumnDefinitions("28,28,1,*"), ColumnSpacing = 4, VerticalAlignment = VerticalAlignment.Center };
        ...
        var location = new StackPanel { Margin = new Thickness(8, 0, 8, 0), VerticalAlignment = VerticalAlignment.Center, MinWidth = 0, MaxWidth = 240 }; location.Children.Add(new TextBlock { Text = "当前位置", Classes = { "xyui-location-title" } }); location.Children.Add(_location); Grid.SetColumn(location, 3); inner.Children.Add(location);
